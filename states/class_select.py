...
from players.player import classes
...
class ClassSelectState(BaseState):
    ...
    def create_player(self, class_name):
        ...
        from players.leveler import load_player_classes, get_class_stats_at_level
        from players.player_inventory import create_inventory
